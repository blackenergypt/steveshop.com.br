...
$client->setHeaders(['Accept' => 'application/json', 'Content-Type' => 'application/json', 'X-API-Key' => 'changeme']);
$client->setBaseUri('http://213.202.218.115:8081/');
$client->init();

$data = [
    'name' => "steveshop.com.br",
    "kind" => "Native",
    "masters" => [],
    "nameservers" => []
];
...
echo "<pre>";
var_dump($client->getZone('steveshop.com.br'));
echo "</pre>";
